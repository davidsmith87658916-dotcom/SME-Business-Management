...
class Customer(Base):
    ...
    business: Any = relationship("Business", back_populates="customers")
    sales: Any = relationship("Sale", back_populates="customer")
    debts: Any = relationship("Debt", back_populates="customer")
    payments: Any = relationship("Payment", back_populates="customer")
